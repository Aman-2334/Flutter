/*Make sure you have a firebase project added to your application and gmail sign in option turned on*/
...
class _AuthState extends State<Auth> {
  ...
  Future signInWithGoogle() async {
    try {
      ...
      widget.showSnackBar(context, 'Error occurred using Google Sign-In. Try again.');
      print(err);
    }
    setState(() {
      googleSignIn = false;
  ...
  void emailLogIn() async {
    ...
    try {
      UserCredential _ = await _auth.signInWithEmailAndPassword(email: email, password: pwd);
    } on FirebaseAuthException catch (e) {
  ...
  void emailSignUp() async {
    try {
      final UserCredential _ = await _auth.createUserWithEmailAndPassword(email: email, password: pwd);
    } on FirebaseAuthException catch (e) {
                                  ...
                                  children: [
                                      ...
                                      validator: (value) {
                                        if (value.isNotEmpty) {
                                          if (_emailCheck.hasMatch(value))
                                            ...
                                            widget.showSnackBar(context, 'Not a valid Email');
                                        } else
                                          widget.showSnackBar(context, 'Email cannot be empty!');
                                        return null;
                                      },
                                      onSaved: (value) {
                                        email = value;
                                    ...
                                    TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        border: OutlineInputBorder(
                                          borderRadius: BorderRadius.vertical(
                                            bottom: signIn ? Radius.circular(10) : Radius.circular(0),
                                          ),
                                        ),
                                        labelText: 'Password',
                                      ),
                                      ...
                                      validator: (value) {
                                        if (value.isNotEmpty) {
                                          if (value.length > 8)
                                            ...
                                            widget.showSnackBar(context, 'Password must be 9 to 15 characters ');
                                        } else
                                          widget.showSnackBar(context, 'Password cannot be empty!');
                                        return null;
                                      },
                                      onSaved: (value) {
                                        pwd = value;
                                        ...
                                        validator: (value) {
                                          if (value.isNotEmpty) {
                                            if (value.length < 16)
                                              ...
                                              widget.showSnackBar(context, 'Username maximum length exceeded');
                                          }
                                          return null;
                                        },
                                        onSaved: (value) {
